...
<div class="container">
	<div class="row">
		<h3 class="text-center">
			<s:message code="banana.login.label.title" />
		</h3>
		<div class="col-md-6 col-md-offset-3">
			<form:form class="form-horizontal" action="${pageContext.request.contextPath}/login" method="POST" modelAttribute="user">
				...
				<div class="form-group">
					<button type="submit" class="btn btn-primary btn-block">
						<s:message code="banana.login.btn.login" />
					</button>
				</div>
