...
<div class="container">
	<h3 class="text-center">
		<s:message code="banana.user.reset.page.title" />
	</h3>
	<div class="col-md-6 col-md-offset-3">
		<form:form class="form-horizontal" method="POST" action="${pageContext.request.contextPath }/reset" modelAttribute="user">
			...
			<div class="form-group">
				<button type="submit" class="btn btn-primary btn-block">
					<s:message code="banana.user.reset.btn.reset" />
				</button>
			</div>
		</form:form>
	</div>
