		...
		<div class="col-md-6 col-md-offset-3">
			...
			<div class="form-group">
				...
				<div class="form-group">
					...
					<form:input type="email" class="form-control" path="email" value="${userForm.email }" required="required" autocomplete="on" autofocus="autofocus" />
				</div>
				<div class="form-group">
					<label for="password"><s:message code="banana.login.label.password"/><span class="text-danger">*</span></label>
					<form:input type="password" class="form-control" path="password" value="${userForm.password }" autocomplete="on" required="required" />
				</div>
				<div class="form-group">
					<button type="submit" class="btn btn-primary btn-block"><s:message code="banana.login.btn.login"/></button>
				</div>
				<div class="pull-right form-group">
					<a href="${pageContext.request.contextPath }/reset"><s:message code="banana.login.txt.fogotpassword"/></a>
				</div>
				<div class="form-group">
