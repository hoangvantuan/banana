...
<div class="container">
  <div class="col-md-6 col-md-offset-3">
    <h3 class="text-center"><s:message code="banana.user.changepassword.label.title"/></h3>
    <form:form method="post" action="${pageContext.request.contextPath }/changepassword" modelAttribute="userForm">
    <div class="form-group">
      ...
      <div class="form-group">
        <label for="new-password"><s:message code="banana.user.changepassword.label.newpassword"/><span class="text-danger">*</span></label> <form:input type="password" class="form-control" path="password" autofocus="on" />
      </div>
      ...
      <button type="submit" class="btn btn-primary btn-block disabled"><s:message code="banana.user.changepassword.btn.change" /></button>
    </form:form>
  </div>
</div>
<!-- END CONTENT -->