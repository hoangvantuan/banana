...
<div class="container">
	<div class="col-md-6 col-md-offset-3">
		<h3 class="text-center">
			<s:message code="banana.account.edit.label.title"></s:message>
		</h3>
		<div>
		...
		<form:form method="post" action="${pageContext.request.contextPath }/account/edit" modelAttribute="account">
			...
			<div class="form-group">
				<label for="url"><s:message code="banana.account.edit.label.domain"></s:message><span class="text-danger">*</span></label>
				<form:input type="text" class="form-control" path="url" value="${account.url }" autofocus="autofocus"/>
			</div>
			<div class="form-group">
				<label for="account"><s:message code="banana.account.edit.label.accountName"></s:message><span class="text-danger">*</span></label>
				<form:input type="text" class="form-control" path="accountName" value="${account.accountName }"/>
			</div>
			<div class="form-group">
				<label for="password"><s:message code="banana.account.edit.label.password"></s:message><span class="text-danger">*</span></label>
				<form:input type="password" class="form-control" path="password" value="${account.password }"/>
			</div>
			<button type="submit" class="btn btn-primary btn-block">
				<s:message code="banana.account.edit.btn.edit"></s:message>
			</button>
		</form:form>
	</div>
</div>
